                      ...
                      <table class="table table-hover" id="tblWorkOrderDone">
                          <thead class="classtheadheader" style="background-color: #36c0c7;height: 6.6vh;">
                              <tr>
                                  ...
                                  <th class="midal1" style="width: 13vw; padding-left: 2vw !important;">FLIGHT</th>
                                  <th class="midal1" style="width: 22vw; padding-left: 3vw !important; "><spam >FROM</spam></th>
                                  <th style="width: 17vw;">BAGGAGE CLAIM</th>
                                  <th style="width: 13vw;">REMARKS</th>
                              </tr>
                          </thead>
                          <tbody>
                            <template v-for="(flight, index) in pagedGroups" :key="flight.flight + '-' + index">
                              ...
                              <tr v-else-if="flight.flight" class="sizerow85">
                                ...
                                <td class="midal1">{{ flight.flight }}</td>
                                <td class="midal1">{{ getFullCityName(flight.city) }}</td>
                                <td class="midal">{{ flight.belt }}</td>
                                <td class="midal1" :class="flight.remark == 'Arrived' ? 'green' : flight.remark == 'Cancelled' ? 'red' : flight.remark == 'Delayed' ? 'yellow' : ''">
                                  {{ flight.remark }}
                                </td>
                              </tr>
                            </template>
