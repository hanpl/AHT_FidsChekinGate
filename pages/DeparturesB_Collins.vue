<template>
    ...
    <section class="content">
          <div class="conten" style="width: 50vw; padding-right: 1.5px;">
            <table class="table table-hover" id="tblWorkOrderDoneLeft">
              <thead class="classtheadheadercl" style="background-color: #36c0c7;height: 6vh;">
                  <tr>
                      <th style="width: 5vw;">STD</th>
                      <th style="width: 11vw;">AIRLINE</th>
                      <th style="width: 6vw;">FLIGHT</th>
                      <th style="width: 12.5vw; "><spam style="float: left; padding-left: 2.4%;">DESTINATION</spam></th>
                      <th style="width: 3vw;">GATE</th>
                      <th style="width: 5vw;">ETD</th>
                      <th style="width: 7.5vw;">REMARK</th>
                  </tr>
              </thead>
              <tbody>
          ...
          <div class="conten" style="width: 50vw; padding-left: 1.5px;">
            <table class="table table-hover" id="tblWorkOrderDoneRight">
                <thead class="classtheadheadercl" style="background-color: #36c0c7;height: 6vh;">
                    <tr>
                        <th style="width: 5vw;">STD</th>
                        <th style="width: 11vw;">AIRLINE</th>
...
function groupFlightsByDayWithBreak(flights: Flight[]) {
  const result: any[] = []
  const filtered = flights.filter(f => Number(f.gate) > 5) 
